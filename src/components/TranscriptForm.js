...
const API_URL = 'https://yt-translate-transcribe-clean-c2e3q8gzh-swedatcodes-projects.vercel.app/api';
...
const TranscriptForm = () => {
    ...
    const fetchAudioStream = async (videoId) => {
        try {
            const response = await axios.get(`${API_URL, videoId}/transcribe`, { responseType: 'arraybuffer' });
